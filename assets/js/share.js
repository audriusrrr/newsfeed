...
Share = (function(_super) {
  ...
  Share.prototype.network_stumbleupon = function() {
    return this.popup('http://www.stumbleupon.com/submit', {
      url: this.config.networks.stumbleupon.url
    });
  };


  Share.prototype.network_linkedin = function() {
    return this.popup('http://www.linkedin.com/shareArticle', {
      url: this.config.networks.linkedin.url,
      mini: "true"
    });
  };
  
  Share.prototype.network_tumblr = function() {
    return this.popup('http://www.tumblr.com/share/link', {
      url: this.config.networks.tumblr.url
    });
  };
  ...
  Share.prototype.network_delicious = function() {
    return this.popup('https://delicious.com/post', {
      url: this.config.networks.delicious.url,
    });
  };
  ...
  Share.prototype.inject_html = function(instance) {
    ...
    return instance.innerHTML = "<label class='entypo-export'><span>" + this.config.ui.button_text +  "<span class='i-circle i-circle-xs'><span class='fa fa-share-alt'></span></span></span></label><div class='social load " + this.config.ui.flyout + "'><ul><li class='fa fa-stumbleupon' data-network='stumbleupon'></li><li class='fa fa-twitter' data-network='twitter'></li><li class='fa fa-facebook' data-network='facebook'></li><li class='fa fa-google-plus' data-network='google_plus'></li><li class='fa fa-paper-plane' data-network='email'></li><li class='fa fa-tumblr' data-network='tumblr'></li><li class='fa fa-linkedin' data-network='linkedin'></li><li class='fa fa-delicious' data-network='delicious'></ul></div>";
  };
